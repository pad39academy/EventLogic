 ...
 * PostgreSQL-compatible version for Google Cloud SQL
 * Usage: node scripts/create-admin-postgres.js
 */
...
async function createAdmin() {
  try {
    console.log('🔐 Ievolve Event Management System - Create Admin User (PostgreSQL)\n');

    // Get database connection using postgres-js instead of neon
